...
"[project]/src/lib/api/daily-hooks.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const dailyHooksAPI = {
    getHooks: async ()=>{
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/daily-hooks');
    }
};
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
...
const notificationsApi = {
    getAll: (params)=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/notifications', {
            params
        }),
    getUnreadCount: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/notifications/unread-count'),
    markAsRead: (notificationIds)=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/notifications/read', {
            notificationIds
        }),
    markAllAsRead: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/notifications/read-all'),
    deleteNotification: (notificationId)=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`/notifications/${notificationId}`),
    getSettings: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/notifications/settings')
};
...
async function getNotifications(params) {
    const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/notifications', {
        params
    });
    return {
...
async function markNotificationsAsRead(notificationIds) {
    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/notifications/read', {
        notificationIds
    });
}
async function markAllNotificationsAsRead() {
    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/notifications/read-all');
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
...
function usePushNotifications(userId) {
        ...
        "usePushNotifications.useCallback[requestPermission]": async ()=>{
            ...
            try {
                ...
                if (permission === 'granted') {
                    ...
                    setState({
                        "usePushNotifications.useCallback[requestPermission]": (prev_8)=>({
                                ...prev_8,
                                isLoading: false
                            })
                    }["usePushNotifications.useCallback[requestPermission]"]);
    ...
    const subscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "usePushNotifications.useCallback[subscribe]": async ()=>{
            return requestPermission();
        }
    }["usePushNotifications.useCallback[subscribe]"], [
        requestPermission
    ]);
    const unsubscribe_0 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "usePushNotifications.useCallback[unsubscribe_0]": async ()=>{
            const token_0 = tokenRef.current;
            if (!token_0) return;
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete('/devices/unregister', {
                    data: {
                        token: token_0
                    }
                });
                ...
                setState({
                    "usePushNotifications.useCallback[unsubscribe_0]": (prev_9)=>({
                            ...prev_9,
                            isTokenRegistered: false,
                            isPermissionGranted: false
                        })
                }["usePushNotifications.useCallback[unsubscribe_0]"]);
            } catch (err_0) {
                console.error('Push notification unregister failed:', err_0);
            }
        }
    }["usePushNotifications.useCallback[unsubscribe_0]"], []);
    return {
        ...
        dismissNotification,
        subscribe,
        unsubscribe: unsubscribe_0
    };
}
_s(usePushNotifications, "zaIU5ueMASiG1tDvd5THHZXQh6U=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_89b395e2._.js.map