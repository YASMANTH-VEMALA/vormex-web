...
function MessageBubble(t0) {
    ...
    if ($[0] !== "b6208dfcc6ecceafc02e350629bb35a5247713160c4497f8614b0b5d06c1bf05") {
        for(let $i = 0; $i < 141; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "b6208dfcc6ecceafc02e350629bb35a5247713160c4497f8614b0b5d06c1bf05";
    }
...
function ChatInput({ conversationId, replyTo, onCancelReply, disabled = false, onUploadingMessagesChange, otherUserId, otherUserName, lastReceivedMessage }) {
    ...
    const handleQuickGrammarFix = async ()=>{
        ...
        try {
            ...
            console.error('Grammar fix error:', error_2);
        } finally{
...
_s(ChatInput, "mSWbV7lXuC/5T2t1+IRrTxgYAhg=");
_c = ChatInput;
var _c;
...
//# sourceMappingURL=src_706842fb._.js.map