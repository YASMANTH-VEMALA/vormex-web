...
async function POST(request) {
    try {
        ...
        const tokenParams = new URLSearchParams({
            ...
            redirect_uri: redirectUri || `${process.env.NEXT_PUBLIC_BASE_URL || ("TURBOPACK compile-time value", "http://localhost:5000/api")?.replace('/api', '') || 'http://localhost:3000'}/auth/google/callback`,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__af560f60._.js.map