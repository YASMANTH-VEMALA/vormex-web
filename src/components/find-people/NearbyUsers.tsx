...
export function NearbyUsers({ onBack }: NearbyUsersProps) {
  ...
  const fetchNearbyUsers = useCallback(async () => {
    try {
      ...
      const result = await getNearbyUsers(radius);
  ...
  return (
    <div className="h-[calc(100vh-200px)] min-h-[500px] flex flex-col bg-gray-50 dark:bg-neutral-950 rounded-xl overflow-hidden">
      {/* Header */}
      <div className="bg-white dark:bg-neutral-900 border-b border-gray-200 dark:border-neutral-800 px-4 py-3 flex items-center justify-between">
