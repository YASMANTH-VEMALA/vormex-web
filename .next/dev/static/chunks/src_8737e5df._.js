...
function ProfileRow(t0) {
    ...
    if ($[0] !== "4474d7dd67e7e9352a698a14ddc7667bffac97c1243bfe6ceacb728e2a87afb8") {
        for(let $i = 0; $i < 22; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "4474d7dd67e7e9352a698a14ddc7667bffac97c1243bfe6ceacb728e2a87afb8";
    }
...
function SavedPostsPage() {
    ...
    const fetchSavedPosts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SavedPostsPage.useCallback[fetchSavedPosts]": async (cursor, append = false)=>{
            try {
                if (!cursor) {
                    setLoading(true);
                } else {
                ...
                const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$saved$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSavedPosts"])(cursor, 20);
                if (append) {
                    setPosts({
                ...
                setTotalCount({
                    "SavedPostsPage.useCallback[fetchSavedPosts]": (prev_0)=>append ? prev_0 + response.posts.length : response.posts.length
                }["SavedPostsPage.useCallback[fetchSavedPosts]"]);
            } catch (error) {
    ...
    const handleLikeUpdate = (postId, liked, count, reactionType, reactionSummary)=>{
        setPosts((prev_1)=>prev_1.map((post)=>post.id === postId ? {
                    ...post,
                    isLiked: liked,
                    likesCount: count,
    ...
    const handlePollUpdate = (postId_0, options)=>{
        setPosts((prev_2)=>prev_2.map((post_0)=>post_0.id === postId_0 ? {
                    ...post_0,
                    pollOptions: options
                } : post_0));
    };
    const handlePostDelete = (postId_1)=>{
        setPosts((prev_3)=>prev_3.filter((post_1)=>post_1.id !== postId_1));
        setTotalCount((prev_4)=>prev_4 - 1);
    };
    const handlePostEdit = (postId_2, updatedPost)=>{
        setPosts((prev_5)=>prev_5.map((post_2)=>post_2.id === postId_2 ? updatedPost : post_2));
    };
    // Handle unsave - remove from list when unsaved
    const handleUnsave = (postId_3)=>{
        setPosts((prev_6)=>prev_6.filter((post_3)=>post_3.id !== postId_3));
        setTotalCount((prev_7)=>Math.max(0, prev_7 - 1));
    };
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            hasMore && nextCursor && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(SavedPostsPage, "7c5cM1Mw3r08dGvOt2Wr+1aA/MU=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
//# sourceMappingURL=src_8737e5df._.js.map