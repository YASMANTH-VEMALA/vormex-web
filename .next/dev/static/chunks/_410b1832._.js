...
function NotificationItem(t0) {
    ...
    if ($[0] !== "e1a13af674bc7fae9b1ff0968b83c0dd6af507747108ecf9ec990b70671cb249") {
        for(let $i = 0; $i < 43; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "e1a13af674bc7fae9b1ff0968b83c0dd6af507747108ecf9ec990b70671cb249";
    }
...
function Notifications({ isOpen = true, onClose, isDropdown = false }) {
        ...
        "Notifications.useEffect": ()=>{
            const socket = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$socket$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initializeSocket"])({
                ...
                onNotificationReaction: {
                    "Notifications.useEffect.socket": (data_2)=>{
                ...
                onNotificationCommentLike: {
                    "Notifications.useEffect.socket": (data_3)=>{
    ...
    const handleMarkAllRead = async ()=>{
        ...
        try {
            ...
            setNotifications((prev_6)=>prev_6.map((n_2)=>({
                        ...n_2,
                        isRead: true
                    })));
            setUnreadCount(0);
...
//# sourceMappingURL=_410b1832._.js.map