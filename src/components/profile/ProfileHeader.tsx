            ...
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
              ...
              <div className="absolute -top-14 sm:relative sm:top-0 left-4 sm:left-0 sm:-mt-24 flex-shrink-0">
                <div className="relative">
                  {/* Avatar with ring */}
                  <div className="w-28 h-28 sm:w-40 sm:h-40 lg:w-44 lg:h-44 rounded-full border-4 border-white dark:border-neutral-900 bg-white dark:bg-neutral-900 shadow-xl overflow-hidden">
                    {user.avatar ? (
                      <img
                        src={user.avatar}
                        alt={user.name}
