...
function SavedPostsPage() {
    ...
    const fetchSavedPosts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (pageNum, append = false)=>{
        try {
            if (pageNum === 1) {
                setLoading(true);
            } else {
            ...
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$saved$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSavedPosts"])(pageNum, 10);
            if (append) {
                setPosts((prev)=>[
                        ...prev,
                        ...response.posts
...
//# sourceMappingURL=src_2c5b5eb0._.js.map