...
function CommentItem({ comment, postId, depth, highlightId, onReply }) {
    ...
    const handleLike = ()=>{
        ...
        try {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$socket$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["likeComment"])(comment.id, postId);
        } catch (error_0) {
            // Revert on error
            setIsLiked(!newLiked);
...
function Comments({ postId, isOpen, onClose, highlightCommentId, onCommentCountChange }) {
                        ...
                        setComments({
                            "Comments.useEffect.handleCommentCreated": (prev)=>{
                                ...
                                const exists = prev.some({
                                    "Comments.useEffect.handleCommentCreated.exists": (c)=>c.id === data.comment.id || c.id.startsWith('temp-')
                                }["Comments.useEffect.handleCommentCreated.exists"]);
                                if (exists) {
                                    // Replace temp comment with real one
                                    return prev.map({
                                        "Comments.useEffect.handleCommentCreated": (c_0)=>c_0.id.startsWith('temp-') ? data.comment : c_0
                    ...
                    "Comments.useEffect.handleCommentLiked": (data_0)=>{
                        ...
                        setComments({
                            "Comments.useEffect.handleCommentLiked": (prev_0)=>prev_0.map({
                                    "Comments.useEffect.handleCommentLiked": (c_1)=>c_1.id === data_0.commentId ? {
                                            ...c_1,
                                            likesCount: data_0.likesCount,
                                            isLiked: data_0.userId === user?.id ? data_0.liked : c_1.isLiked
                                        } : c_1
    ...
    const handleSubmit = async ()=>{
        ...
        try {
            // Use WebSocket for real-time
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$socket$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createComment"])(postId, newComment.trim(), replyingTo?.id, mentions);
            // Optimistic update
            const tempComment = {
                id: `temp-${Date.now()}`,
                postId,
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    comments.map((comment)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(CommentItem, {
                                            comment: comment,
                                            postId: postId,
                                            depth: 0,
...
const createStory = async (data)=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/stories', data);
    return response.data;
};
...
const getStory = async (storyId)=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/stories/${storyId}`);
    return response.data;
};
const getMyStories = async (includeExpired = false)=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/stories/me', {
        params: {
            includeExpired
        }
    });
...
const deleteStory = async (storyId)=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`/stories/${storyId}`);
    return response.data;
};
const getUserStories = async (userId)=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/stories/user/${userId}`);
    return response.data;
};
const viewStory = async (storyId, duration)=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`/stories/${storyId}/view`, {
        duration
    });
    return response.data;
};
const getStoryViewers = async (storyId, cursor, limit = 20)=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/stories/${storyId}/viewers`, {
        params: {
            cursor,
            limit
        }
...
const reactToStory = async (storyId, reactionType)=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`/stories/${storyId}/react`, {
        reactionType
    });
    return response.data;
};
const removeReaction = async (storyId)=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`/stories/${storyId}/react`);
    return response.data;
};
const replyToStory = async (storyId, content, mediaUrl)=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`/stories/${storyId}/reply`, {
        content,
        mediaUrl
    });
    return response.data;
...
const getStoryReplies = async (storyId)=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/stories/${storyId}/replies`);
    return response.data;
};
const createHighlight = async (data)=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/stories/highlights', data);
    return response.data;
};
const getUserHighlights = async (userId)=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/stories/highlights/user/${userId}`);
    return response.data;
};
const getHighlightStories = async (highlightId)=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/stories/highlights/${highlightId}`);
    return response.data;
};
const updateHighlight = async (highlightId, data)=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].patch(`/stories/highlights/${highlightId}`, data);
    return response.data;
};
const deleteHighlight = async (highlightId)=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`/stories/highlights/${highlightId}`);
    return response.data;
};
const addStoryToHighlight = async (highlightId, storyId)=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`/stories/highlights/${highlightId}/stories/${storyId}`);
    return response.data;
};
const removeStoryFromHighlight = async (highlightId, storyId)=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`/stories/highlights/${highlightId}/stories/${storyId}`);
    return response.data;
};
const archiveStory = async (storyId)=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`/stories/${storyId}/archive`);
    return response.data;
};
const getArchivedStories = async ()=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/stories/archive');
    return response.data;
};
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
...
function Feed() {
    ...
    const [selectedStoryGroupIndex, setSelectedStoryGroupIndex] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Feed.useEffect": ()=>{
            ...
            const socket = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$socket$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initializeSocket"])({
                onConnect: {
                    "Feed.useEffect.socket": ()=>{
                        console.log('Feed: Socket connected');
                    }
                }["Feed.useEffect.socket"],
                onPostCreated: {
                    "Feed.useEffect.socket": ({ post })=>{
                        // Add new post to the top of the feed in real-time
                        setPosts({
                            "Feed.useEffect.socket": (prev)=>{
                                // Check if post already exists to avoid duplicates
                                if (prev.some({
                                    "Feed.useEffect.socket": (p)=>p.id === post.id
                                }["Feed.useEffect.socket"])) return prev;
                                return [
                                    post,
                                    ...prev
                                ];
                ...
                onPostLiked: {
                    "Feed.useEffect.socket": ({ postId, userId: likerUserId, liked, likesCount, reactionType, reactionSummary })=>{
                        setPosts({
                            "Feed.useEffect.socket": (prev_0)=>prev_0.map({
                                    "Feed.useEffect.socket": (post_0)=>{
                                        if (post_0.id !== postId) return post_0;
                ...
                onPostReacted: {
                    "Feed.useEffect.socket": ({ postId: postId_0, userId: reactorUserId, liked: liked_0, reactionType: reactionType_0, likesCount: likesCount_0, reactionSummary: reactionSummary_0 })=>{
                        setPosts({
                            "Feed.useEffect.socket": (prev_1)=>prev_1.map({
                                    "Feed.useEffect.socket": (post_1)=>{
                                        if (post_1.id !== postId_0) return post_1;
                                        // Only update isLiked/reactionType if the current user performed the action
                ...
                onCommentCreated: {
                    "Feed.useEffect.socket": ({ postId: postId_1, commentsCount })=>{
                        setPosts({
                            "Feed.useEffect.socket": (prev_2)=>prev_2.map({
                                    "Feed.useEffect.socket": (post_2)=>post_2.id === postId_1 ? {
                                            ...post_2,
                                            commentsCount
                                        } : post_2
                                }["Feed.useEffect.socket"])
                ...
                onPollUpdated: {
                    "Feed.useEffect.socket": ({ postId: postId_2, pollOptions })=>{
                        setPosts({
                            "Feed.useEffect.socket": (prev_3)=>prev_3.map({
                                    "Feed.useEffect.socket": (post_3)=>post_3.id === postId_2 ? {
                                            ...post_3,
                                            pollOptions
                                        } : post_3
                                }["Feed.useEffect.socket"])
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Feed.useEffect": ()=>{
            ...
            const fetchFeed = {
                "Feed.useEffect.fetchFeed": async ()=>{
                    setLoading(true);
                    setError(null);
                    try {
                        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$posts$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFeed"])(undefined, 20);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Feed.useEffect": ()=>{
            ...
            const fetchStories = {
                "Feed.useEffect.fetchStories": async ()=>{
                    try {
                        const stories = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$stories$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getStoriesFeed"])();
                        setStoryGroups(stories);
                    } catch (err_0) {
                        console.error('Error fetching stories:', err_0);
                    }
                }
            }["Feed.useEffect.fetchStories"];
            fetchStories();
        }
    }["Feed.useEffect"], [
        authLoading,
    ...
    // Refresh stories after creating one
    const handleStoryCreated = async ()=>{
        try {
            const stories_0 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$stories$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getStoriesFeed"])();
            setStoryGroups(stories_0);
        } catch (err_1) {
            console.error('Error refreshing stories:', err_1);
        }
    };
    ...
    const loadMore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Feed.useCallback[loadMore]": async ()=>{
            ...
            setLoadingMore(true);
            try {
                const response_0 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$posts$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFeed"])(cursor, 20);
                setPosts({
                    "Feed.useCallback[loadMore]": (prev_4)=>[
                            ...prev_4,
                            ...response_0.posts
                        ]
                }["Feed.useCallback[loadMore]"]);
                setCursor(response_0.nextCursor);
                setHasMore(response_0.hasMore ?? response_0.nextCursor !== null);
            } catch (err_2) {
                console.error('Error loading more posts:', err_2);
            } finally{
                setLoadingMore(false);
            }
        }
    ...
    const retryFeed = async ()=>{
        ...
        setCursor(null);
        try {
            const response_1 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$posts$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFeed"])(undefined, 20);
            setPosts(response_1.posts);
            setCursor(response_1.nextCursor);
            setHasMore(response_1.hasMore ?? response_1.nextCursor !== null);
        } catch (err_3) {
            console.error('Error loading feed:', err_3);
            setError(err_3.response?.data?.error || 'Failed to load feed');
        } finally{
            setLoading(false);
        }
    };
    ...
    // Handle post deleted
    const handlePostDeleted = (postId_3)=>{
        setPosts((prev_5)=>prev_5.filter((post_4)=>post_4.id !== postId_3));
    };
    // Handle post edited
    const handlePostEdited = (postId_4, updatedPost)=>{
        setPosts((prev_6)=>prev_6.map((post_5)=>post_5.id === postId_4 ? {
                    ...post_5,
                    ...updatedPost
                } : post_5));
    };
    // Handle like update
    const handleLikeUpdate = (postId_5, liked_1, count)=>{
        setPosts((prev_7)=>prev_7.map((post_6)=>post_6.id === postId_5 ? {
                    ...post_6,
                    isLiked: liked_1,
                    likesCount: count
                } : post_6));
    ...
    // Handle poll update
    const handlePollUpdate = (postId_6, options)=>{
        setPosts((prev_8)=>prev_8.map((post_7)=>post_7.id === postId_6 ? {
                    ...post_7,
                    pollOptions: options
                } : post_7));
    };
    // Handle comment click
    const handleCommentClick = (postId_7)=>{
        setSelectedPostForComments(postId_7);
        setHighlightCommentId(undefined);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$socket$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["joinPostRoom"])(postId_7);
    };
    // Close comments
    const closeComments = ()=>{
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    !hasMore && posts.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "text-sm text-gray-400 dark:text-neutral-500",
            ...
            selectedPostForComments && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$feed$2f$Comments$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Comments"], {
                ...
                onCommentCountChange: (count_0)=>{
                    setPosts((prev_9)=>prev_9.map((post_9)=>post_9.id === selectedPostForComments ? {
                                ...post_9,
...
_s(Feed, "1uIDnJVDgzkJcVMHE105ZG5GYsg=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2f$useAuth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
...
//# sourceMappingURL=src_ba2e8198._.js.map